...
\begin{dem}
    ...
    que vale conforme o \Cref{int-corol-produtoRegraSinal2}.
...
\end{corol}
\begin{dem}
    Pelo \Cref{rac-teo-trocaSinaisNumeradorDenominador} temos que $\frac{-a}{b} = \frac{a}{-b}$. Os denominadores são $b$ e $-b$, ambos não nulos, logo pelo \Cref{int-corol-numeroOuSimetricoPositivo}, ao menos um deles é positivo.
\end{dem}
...
\begin{afi}
    A \Cref{rac-def-relacaoOrdem} não pode ser enfraquecida apenas retirando-se a obrigatoriedade dos denominadores serem positivos.
\end{afi}
...
\end{dem}
\begin{obs}
    Aplicando o \Cref{rac-corol-terceiroEntreDois}, pode-se obter que entre quaisquer dois racionais distintos, há uma quantidade infinita de números racioanais. Vamos sobre conjuntos finitos e infinitos no \Cref{cap-enumerabilidade}.
\end{obs}
