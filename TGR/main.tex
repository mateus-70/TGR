...
{\llap{\makebox[1.5cm][l]{\bfseries\etocnumber}}\bfseries\etocname
  \hspace{10pt}\nobreak\dotfill\hspace{10pt}\etocpage\par}
{}
...
% \etocsetstyle{chapter}{}{}{\noindent\old@chapter{\noindent\old@chapternumberline{\noindent\etocnumber}\etoclink{\noindent\normalsize\bfseries\MakeUppercase\etocthename}}{\noindent\etocpage}}{}%
...
\newenvironment{dem}[1][\textbf{Demonstração:} \ ]{\noindent\trivlist\vspace{-5mm}\item\ignorespaces\textbf{#1}}{\hfill\rule{2mm}{2mm}\endtrivlist }
...
\pdfbookmark[0]{\contentsname\bfseries}{toc}
\tableofcontents*
\cleardoublepage
