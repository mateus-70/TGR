...
A ideia por trás da \Cref{reais-def-corte} é que um corte é um subconjunto próprio do conjunto dos números racionais que não admite máximo e tal que, dado qualquer elemento do corte, todos os elementos que o precedem pela relação de ordem nos racionais, também está no corte.
...
\end{prop}
\begin{dem}
    Vamos utilizar a \Cref{reais-def-modulo2} e a \Cref{reais-prop-moduloDoMenos}, analogamente à prova anterior (\Cref{reais-teo-regraSinaisProduto1}).
    \begin{enumerate}
        \item $\alpha \geq 0^*$ e $\beta \geq 0^*$: \\
            Temos $-\alpha \leq 0^*$ e $-\beta \leq 0^*$. Assim
            \[ (-\alpha)(-\beta) = \abs{-\alpha}\abs{-\beta} = \alpha\beta.\]
