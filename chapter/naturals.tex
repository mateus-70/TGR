...
\begin{dem}
    ...
    $y = k$, $s(y) = s(k)$, dessa forma $s(k) \in \mathbb{N}$. Pelo \Cref{axi-ind-finita} temos que $\mathbb{S}$ = $\mathbb{N}$.

    A unicidade do $y$ que usamos na construção de $\mathbb{S}$ advém do \Cref{axi-s-injetora}, $s(z) = s(y) = x \implies z = y$ pela injetividade de $s$.
\end{dem}
\begin{obs}
...
\begin{dem}
    ...
    \begin{enumerate}[label=(\roman*)]    
        \item Fechamento: \\
            Seja $\mathbb{S} = \{ x \in \mathbb{N} : a + x \in \mathbb{N} \}$. Obviamente o $1$ está em $\mathbb{S}$. Suponhamos então que existe $k \in \mathbb{S}$, queremos saber se isso garante que $s(k) \in \mathbb{S}$. Temos então que $a + k \in \mathbb{N}$, já para $a + s(k) = s(a + k) \in \mathbb{S}$, pois pelo \Cref{axi-existe-n-s} a função tem domínio e contradomínio $\mathbb{N}$.
        \item Associativa: \\
        ...
        \item Lei do cancelamento: \\
            Seja $\mathbb{S} = \{ x \in \mathbb{N} : x + b = x + c \implies b = c \}$, vamos provar que $\mathbb{S}$ = $\mathbb{N}$. Obviamente o $1$ está em $\mathbb{S}$ pois $1 + b = 1 + c \iff b + 1 = c + 1$ e pelo \Cref{axi-s-injetora}, se dois elementos tem sucessores iguais, eles próprios são iguais. Agora consideremos se vale que $(k + b = k + c \implies b = c) \implies (s(k) + b = s(k) + c \implies b = c)$. \\
...
\begin{dem}
    ...
    \begin{enumerate}[label=(\roman*)]
        \item Fechamento: \\
            ...
            O $1$ está em $\mathbb{S}$ pois $1 \cdot 1 = 1$. Supondo que é válido $ak \in \mathbb{N}$ para algum $k \in \mathbb{N}$, temos $a \cdot s(k) = ak + a$, como tanto $ak$ quanto $a$ são números naturais, e como a soma é fechada em $\mathbb{N}$, temos $ak + a \in \mathbb{N}$. Pelo \Cref{axi-ind-finita}, $\mathbb{S}$ = $\mathbb{N}$. 
        \item Elemento neutro: \\
            ...
            Temos $1 \cdot s(k) = 1 \cdot k + 1 = k \cdot 1 + 1 = k + 1 = s(k) = s(k) \cdot 1$. Pelo \Cref{axi-ind-finita}, $\mathbb{S} = \mathbb{N}$.
        ...
        \item Distributiva à direita: 
            ...
            = a \cdot s(k) + b \cdot s(k)$. Pelo \Cref{axi-ind-finita} tem-se que $\mathbb{S} = \mathbb{N}$.
            \\ \\
            ...
            % a \cdot s(k) + b \cdot s(k)$, e pelo \Cref{axi-ind-finita} concluímos que \mathbb{S} = \mathbb{N}.
        \item Comutativa: \\
            Seja $\mathbb{S} = \{ x \in \mathbb{N} : ax = xa \}$. Com certeza o $1$ está em $\mathbb{S}$, porque $1$ é o neutro da multiplicação. Agora suponhamos que $k \in \mathbb{S}$, vejamos se $s(k) \in \mathbb{S}$. Temos então: $a \cdot s(k) = ak + a = 1 \cdot a + ka = (1+k)a = s(k) \cdot a$. Pelo \Cref{axi-ind-finita} tem-se que $\mathbb{S}$ = $\mathbb{N}$.
        ...
        \item Associativa:  \\
            ...
            $a(b \cdot s(k)) = a(bk + b) = abk + ab = s(k) \cdot  (ab)$, o que pelo \Cref{axi-ind-finita} tem-se que $\mathbb{S}$ = $\mathbb{N}$. 
            
            
            
        \item Lei do cancelamento: \\
            Seja $\mathbb{S} = \{ x \in \mathbb{N} : xb = xc \implies b = c\}$. O $1$ está em $\mathbb{S}$ pois $1b = 1c \implies b = c$. Provemos que $k\in \mathbb{S} \implies s(k) \in \mathbb{S}$. Temos que $s(k) \cdot b = s(k) \cdot c \iff b + bk = c + ck \iff b = c$. Pelo \Cref{axi-ind-finita} tem-se que $\mathbb{S}$ = $\mathbb{N}$.
...
\begin{dem}
    ...
    \begin{enumerate}[label=(\roman*)]
        ...
        Portanto, em todos os casos, $s(k) \in \mathbb{S}$, e pelo \Cref{axi-ind-finita}, $\mathbb{S}$ = $\mathbb{N}$.
