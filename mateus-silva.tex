...
\axi{Zero é um número natural}\label{P1}
\axi{Se $a$ é um número natural, então $a$ tem um único sucessor que também é um número natural}\label{P2}
\axi{Zero não é sucessor de nenhum número natural}\label{P3}
\axi{Dois números naturais que têm sucessores iguais são, eles próprios, iguais.}\label{P4}
\axi{Se uma coleção $S$ de números naturais contém o zero e, também o sucessor de todo elemento de $S$, então $S$ é o conjunto de todos os números naturais.}\label{P5}
